...
int main()
{
	...
	//*************** return 0; دعواتكم معي نازل اشوف ***************
	//****************************************************************
	ios_base::sync_with_stdio(false), cin.tie(0), cout.tie(0); // Mbappé 
	//****************************************************************
...
/*	//************************************************************** 
	                      // 49 : A. Alyona and Numbers
	long long n, m, freqn[5] = { 0 }, freqm[5] = { 0 };
	cin >> n >> m;
	for (int i = 1; i <= n; i++)
	{
		freqn[i % 5]++;
	...
	cout << (freqn[0] * freqm[0] + freqn[1] * freqm[4] + freqn[2] * freqm[3] + freqn[3] * freqm[2] + freqn[4] * freqm[1]) << endl;
	//************************************************************** */
...
/*	//************************************************************** 
	                      // 48 : A. Polo the Penguin and Segments
...
/*	//************************************************************** 
	                  // 38 : A. Mahmoud and Longest Uncommon Subsequence
	string a, b;
	cin >> a >> b;
	if (a == b)
	{
